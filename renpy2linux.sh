...
#Script originally by Shizmob
#bash renpy2linux.sh "game subdir name" "Ren'Py version #"

#In the renpy subdir you can find an __init__.py file that contains
# a variable declaration that will look something like this:
#version_tuple = (6, 99, 11, vc_version)
#Would equate to 6.99.11
...
echo "\o/ Done!"
echo "Remember to set the launch script to executable"
